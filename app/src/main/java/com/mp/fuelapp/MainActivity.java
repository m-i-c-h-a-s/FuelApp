    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch(item.getItemId()) {
            ...
            case R.id.generateExampleData:
                ...
                databaseHelper.addRefueling(31.3, 229.43,7.33, "14-02-2023", img);
                databaseHelper.addRefueling(23.1, 176.58,7.64, "24-02-2023", img);
                databaseHelper.addRefueling(52.7, 381.02,7.23, "12-03-2023", img);
                databaseHelper.addRefueling(31.4, 230.16,7.33, "24-03-2023", img);
                databaseHelper.addRefueling(26.6, 203.76,7.66, "02-04-2023", img);
                databaseHelper.addRefueling(17.8, 135.81,7.63, "12-04-2023", img);
                databaseHelper.addRefueling(33.4, 263.53,7.89, "22-04-2023", img);
                databaseHelper.addRefueling(41.2, 330.42,8.02, "23-04-2023", img);
                databaseHelper.addRefueling(28.1, 211.31,7.52, "24-04-2023", img);
                databaseHelper.addRefueling(51.7, 389.30,7.53, "25-04-2023", img);
                databaseHelper.addRefueling(31.9, 249.46,7.82, "26-04-2023", img);
                databaseHelper.addRefueling(12.8, 97.67,7.63, "27-04-2023", img);
                databaseHelper.addRefueling(16.3, 120.79,7.41, "28-04-2023", img);
                databaseHelper.addRefueling(21.1, 159.52,7.56, "29-04-2023", img);
                this.recreate();
                break;
            default:
                break;
